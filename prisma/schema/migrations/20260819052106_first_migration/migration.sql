...
-- CreateTable
CREATE TABLE "docx_style_configs" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "docx_generation_jobs" (
    "id" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "docx_style_configs_config_hash_key" ON "docx_style_configs"("config_hash");

-- CreateIndex
CREATE INDEX "docx_style_configs_created_by_idx" ON "docx_style_configs"("created_by");

-- CreateIndex
CREATE INDEX "docx_generation_jobs_sets_hash_style_config_id_idx" ON "docx_generation_jobs"("sets_hash", "style_config_id");

-- CreateIndex
CREATE INDEX "docx_generation_jobs_status_idx" ON "docx_generation_jobs"("status");

-- CreateIndex
CREATE INDEX "docx_documents_sets_hash_idx" ON "docx_documents"("sets_hash");

-- CreateIndex
CREATE UNIQUE INDEX "docx_documents_sets_hash_style_config_id_key" ON "docx_documents"("sets_hash", "style_config_id");
...
-- AddForeignKey
ALTER TABLE "docx_style_configs" ADD CONSTRAINT "docx_style_configs_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "docx_generation_jobs" ADD CONSTRAINT "docx_generation_jobs_style_config_id_fkey" FOREIGN KEY ("style_config_id") REFERENCES "docx_style_configs"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "docx_documents" ADD CONSTRAINT "docx_documents_style_config_id_fkey" FOREIGN KEY ("style_config_id") REFERENCES "docx_style_configs"("id") ON DELETE CASCADE ON UPDATE CASCADE;
