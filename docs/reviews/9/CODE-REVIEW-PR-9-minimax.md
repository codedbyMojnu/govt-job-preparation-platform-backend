...
| ------------------------------------------------- | ------ | ---- | ----------------------------- |
| src/config/**tests**/env-schema.test.ts           | Added  | +68  | 9 tests for env validation    |
...
| src/shared/errors/**tests**/errors.test.ts        | Added  | +112 | 12 error tests                |
...
| src/shared/utils/**tests**/async-handler.test.ts  | Added  | +35  | 2 async handler tests         |
| src/shared/utils/**tests**/correlation-id.test.ts | Added  | +24  | 3 correlation ID tests        |
...
_Generated by /review — 2025-03-18 09:07_
